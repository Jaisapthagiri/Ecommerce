    ...
    return (
        <div className='relative mt-24'>
            ...
            <div className='flex flex-col items-center pt-16 
                            md:absolute md:inset-0 md:items-start md:justify-center md:pt-0 md:pl-24'>
                <div className="flex flex-col gap-4 w-[90%] md:w-[400px]">
                    <h1 className='text-2xl md:text-3xl font-semibold text-purple-500'>
                        Why We Are the Best?
                    </h1>
                    {features.map((feature, index) => (
                        <div key={index} className="flex items-start gap-4 p-2 rounded-md">
                            <div className="w-10 h-10 min-w-10 bg-purple-500 flex items-center justify-center rounded-md">
                            ...
                            <div>
                                ...
                                <p className="text-md text-green-500">{feature.description}</p>
                            </div>
                        </div>
                    ))}
                </div>
