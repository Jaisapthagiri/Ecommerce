...
const Navbar = () => {
    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <NavLink to='/'>
                <img className="h-9" src={assets.log} alt="dummyLogoColored" />
            </NavLink>

            {/* Desktop Menu */}
            <div className="hidden sm:flex items-center gap-8">

                <NavLink to='/seller' className="px-4 py-1 border border-gray-300 rounded-full text-xs hover:bg-primary/10 transition">Admin Dashboard</NavLink>
